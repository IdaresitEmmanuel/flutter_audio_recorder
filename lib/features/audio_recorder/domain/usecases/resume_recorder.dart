...
class ResumeRecorderUsecase extends Usecase<DataState<Unit>, void> {
  final AudioRecorderRepository _audioRecorderRepository;
  ResumeRecorderUsecase(this._audioRecorderRepository);
  @override
  Future<DataState<Unit>> call({void params}) {
    return _audioRecorderRepository.resume();
  }
}
